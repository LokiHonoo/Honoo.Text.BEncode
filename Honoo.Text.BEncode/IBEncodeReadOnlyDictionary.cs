...
namespace Honoo.Text.BEncode
{
    ...
    public interface IBEncodeReadOnlyDictionary
    {
        ...
        BEncodeValue this[BEncodeString key] { get; }
        ...
        /// <param name="key">元素的键。</param>
        /// <returns></returns>
        BEncodeValue this[string key] { get; }
        ...
        BEncodeValue this[string key, Encoding keyEncoding] { get; }
        ...
        /// </summary>
        /// <returns></returns>
        IEnumerator<KeyValuePair<BEncodeString, BEncodeValue>> GetEnumerator();
        ...
        /// <param name="key">元素的键。</param>
        /// <returns></returns>
        T GetValue<T>(BEncodeString key) where T : BEncodeValue;
        ...
        /// <returns></returns>
        /// <exception cref="Exception"/>
        T GetValue<T>(string key) where T : BEncodeValue;
        ...
        /// <returns></returns>
        /// <exception cref="Exception"/>
        T GetValue<T>(string key, Encoding keyEncoding) where T : BEncodeValue;
        ...
        /// <returns></returns>
        T GetValue<T>(BEncodeString key, T defaultValue) where T : BEncodeValue;
        ...
        /// <returns></returns>
        /// <exception cref="Exception"/>
        T GetValue<T>(string key, T defaultValue) where T : BEncodeValue;
        ...
        /// <returns></returns>
        /// <exception cref="Exception"/>
        T GetValue<T>(string key, Encoding keyEncoding, T defaultValue) where T : BEncodeValue;
        ...
        /// <returns></returns>
        bool TryGetValue<T>(BEncodeString key, out T value) where T : BEncodeValue;
        ...
        /// <returns></returns>
        /// <exception cref="Exception"/>
        bool TryGetValue<T>(string key, Encoding keyEncoding, out T value) where T : BEncodeValue;
        ...
        /// <returns></returns>
        /// <exception cref="Exception"/>
        bool TryGetValue<T>(string key, out T value) where T : BEncodeValue;
    }
}